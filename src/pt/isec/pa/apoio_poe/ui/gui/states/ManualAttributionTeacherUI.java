...
public class ManualAttributionTeacherUI extends BorderPane {
    ...
    public ManualAttributionTeacherUI(AppManager appManager) {
    ...
    private void createViews() {
        ...
        btnAssociarProposta = new Button("Associar Docente");
        ...
        btnDesassociar = new Button("Desassociar Docente");
    ...
    private void registerHandlers() {
        ...
        btnDesassociar.setOnAction(ev-> {
            ...
            result.ifPresent(s-> {
                appManager.desassociateDocente(s);
            });
            areaText.clear();
            areaText.setText("Docentes:\n " + appManager.getDocentesString()+ "\nPropostas: " + appManager.getPropostasString());
        });
        btnAssociarProposta.setOnAction(ev-> {
            ...
            tid2.setHeaderText("Email Docente: ");
            tid2.setContentText("Email");
            Optional<String> result2 = tid2.showAndWait();
            result.ifPresent(s-> {

                result2.ifPresent(email-> {
                    appManager.associateDocente(email,s);
    ...
    private void update() {
        if (appManager.getState() != AppState.MANUAL_ATTRIBUTION_TEACHER_STATE) {
